...
ENV PATH=$PATH:/home/ms-compras/.local/bin

# Crear el usuario ms-compras y su directorio home
RUN useradd --create-home --home-dir /home/ms-compras ms-compras
